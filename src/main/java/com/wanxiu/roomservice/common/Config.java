package com.wanxiu.roomservice.common;
...
public class Config {
    ...
    public class IM {
         ...
         */
        public final static long IM_SDKAPPID = 1400183986;
        ...
        public final static String PUBLICKEY = "-----BEGIN PUBLIC KEY-----\n" +
                "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEq/SIfbImbTkptKzEAV5a+YZJ+WD3\n" +
                "j/ekSyDvHBoydsu6utO2j7viHHAT5z3bT3JpJJf4XZe7l9QMTaz7tQgNhQ==\n" +
                "-----END PUBLIC KEY-----\n";
    }
     ...
     * 此配置项只针对双人和多人实时音视频
     */
    public final static boolean isCreatorDestroyRoom = true;
}
