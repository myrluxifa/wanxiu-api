package com.wanxiu.roomservice.pojo;

import com.wanxiu.roomservice.pojo.Response.BaseRsp;
...
public class Room extends BaseRsp {
    ...
    public ArrayList<Pusher> getPushers() {
        return pushers;
    }

    public void setPushers(ArrayList<Pusher> pushers) {
